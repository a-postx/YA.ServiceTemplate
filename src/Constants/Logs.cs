namespace YA.ServiceTemplate.Constants
{
    public static class Logs
    {
        ...
        public const string MessageBusContextType = nameof(MessageBusContextType);
        public const string MessageBusSourceAddress = nameof(MessageBusSourceAddress);
        public const string MessageBusDestinationAddress = nameof(MessageBusDestinationAddress);
        public const string MessageBusMessageId = nameof(MessageBusMessageId);
        public const string MessageBusConversationId = nameof(MessageBusConversationId);
        public const string MessageBusMessage = nameof(MessageBusMessage);
    }
}
